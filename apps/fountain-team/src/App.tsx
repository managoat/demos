...
import type { Conversation, LogEvent, Schedule, SearchHit, TeamEvent, Teammate, Turn } from "./api/types";
...
function Team({ settings, onSettings, onSignOut }: { settings: Settings; email: string | null; onSettings: () => void; onSignOut: () => void }) {
  ...
  const onRowAction = useCallback(
    ...
    [team, client, updatePrefs, removeTeammate, retireThread, toast, select, openThread],
  );
