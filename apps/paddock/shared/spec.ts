...
export function welcomePrompt(input: { slug: string; repoPath: string | null }): string {
  return [
    ...
    "  - Setup is where repositories, packages, a setup script, secrets, MCP",
    "    servers and skills go; Details is what the box actually has, and",
    "    nothing declared reaches it until it is applied — which is a turn",
    "    they will watch happen here",
