/**
 * "Sign in with Fountain" for paddock — see `@managoat/fountain-app/oauth`.
 *
...
export const { beginLogin, completeLoginIfCallback, revoke } = createOAuth("paddock");
